...
from fwp.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
...
class ModelTrainer:
    def __init__(self, data_transformation_artifact: DataTransformationArtifact, model_trainer_config: ModelTrainerConfig):
        ...
        self.model: Module = models.vgg16(pretrained=True)
    ...
    def train(self, optimizer: Optimizer) -> None:
        ...
        try:
            ...
            for batch_idx, (data, target) in enumerate(pbar):
                ...
                loss = F.cross_entropy(y_pred, target)  # Using cross_entropy for multi-class classification
                loss.backward()
                optimizer.step()
        ...
        try:
            ...
            with torch.no_grad():
                for data, target in self.data_transformation_artifact.transformed_test_object:
                    ...
                    test_loss += F.cross_entropy(output, target, reduction="sum").item()  # Using cross_entropy
