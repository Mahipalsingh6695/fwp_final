...
BUCKET_NAME: str = "fwproject"

S3_DATA_FOLDER: str = "fwdata"


# data trasnforamtion
CLASS_LABEL_1: str = "Orignal"

CLASS_LABEL_2: str = "Fake"
...
TRAIN_TRANSFORMS_KEY: str = "fwp_train_transforms"
...
BENTOML_MODEL_NAME: str = "fwp_model"

BENTOML_SERVICE_NAME: str = "fwp_service"

BENTOML_ECR_URI: str = "fwp_bento_image"
