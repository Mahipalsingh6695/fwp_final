import sys
from fwp.components.data_ingestion import DataIngestion
from fwp.components.data_transformation import DataTransformation
...
from fwp.entity.config_entity import (
    DataIngestionConfig,
